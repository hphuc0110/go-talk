    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 text-balance">Tại Sao Chọn GoTalk?</h2>
            ...
            return (
              <Card key={index} className="group hover:shadow-lg transition-all duration-300 border-0 shadow-sm">
                <CardHeader className="text-center pb-4">
                  <div className="mx-auto w-16 h-16 bg-[#3264C3]/10 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-[#3264C3] transition-colors duration-300">
                    <Icon className="h-8 w-8 text-[#3264C3] group-hover:text-white transition-colors duration-300" />
                  </div>
