    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-in zoom-in-95 slide-in-from-bottom-8 duration-300">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900">Đăng ký học GoTalk</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 h-12 border-gray-200 focus:border-[#3264C3] focus:ring-[#3264C3] transition-colors duration-200"
                required
              />
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full h-12 bg-[#3264C3] hover:bg-[#3264C3]/90 text-white font-medium text-lg transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <p className="text-xs text-gray-500 text-center">
            ...
            <a href="#" className="text-[#3264C3] hover:underline">
              Điều khoản dịch vụ
            </a>{" "}
            và{" "}
            <a href="#" className="text-[#3264C3] hover:underline">
