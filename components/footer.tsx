    ...
    <footer className="bg-gray-50 pt-20 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-3 gap-12 mb-16">
          {/* Contact Info */}
          <div>
            <h3 className="text-xl font-bold text-[#3264c3] mb-6">Thông tin liên hệ</h3>
          ...
          {/* About */}
          <div>
            <h3 className="text-xl font-bold text-[#3264c3] mb-6">Về GOTALK</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="flex items-center gap-2 text-gray-700 hover:text-[#3264c3] transition-colors">
                  <div className="w-2 h-2 bg-[#3264c3] rounded-full"></div>
                  Liên hệ
                </a>
              </li>
              <li>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-bold text-[#3264c3] mb-6">Thông tin khác</h3>
            <ul className="space-y-3">
              {[
                "Liên hệ ",
                "FAQS",
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-8">
              <div className="text-2xl font-bold text-[#3264c3]">HLE</div>
              <div className="text-gray-600 text-sm">HLE © Copyright 2025</div>
              <a href="#" className="text-gray-600 hover:text-[#3264c3] text-sm">
                Privacy Policy
              </a>
            </div>
        ...
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 left-8 bg-[#3264c3] text-white p-3 rounded-full shadow-lg hover:bg-[#b50001] transition-colors z-50"
        >
