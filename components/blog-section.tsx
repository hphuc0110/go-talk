...
export function BlogSection() {
  const blogPosts = [
    ...
    {
      title: "Flipped Classroom tại GoTalk – Giải pháp Học Tập Hiệu Quả Cho Người Đi Làm Bận Rộn",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-4">
            <span className="text-[#3264C3]">Blog</span> GoTalk
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Khám phá kiến thức và kỹ năng thuyết trình hiện đại cùng chuyên gia GoTalk
          </p>
        </div>
          ...
          {blogPosts.map((post, index) => (
            ...
            >
              ...
              <div className="relative aspect-video">
                ...
                />
                <span className="absolute top-3 left-3 bg-[#3264C3] text-white text-xs font-medium px-3 py-1 rounded-full shadow-md">
                  {post.category}
                </span>
              </div>
              ...
              <div className="p-6 flex flex-col h-full">
                <h3 className="text-black font-bold text-lg mb-3 leading-snug line-clamp-3 group-hover:text-[#3264C3] transition-colors">
                  {post.title}
                </h3>
                ...
                <Link
                  href={post.link}
                  className="mt-auto inline-flex items-center justify-center gap-2 bg-[#3264C3] hover:bg-[#2451A3] text-white font-semibold py-2.5 px-5 rounded-lg transition-colors"
                >
